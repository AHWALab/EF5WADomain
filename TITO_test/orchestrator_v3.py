...
def run_ml_nowcast(currentTime,precipFolder):
    ...
    try:
        # Command 1: python m_tif2h5py.py
        cmd1 = [
            'python3',
            'ML/m_tif2h5py.py',
            precipFolder,
            'ML/temp/input_imerg.h5'
        ]
        ...
        cmd2 = [
            ...
            'ML/m_nowcasting.py',
            'ML/nowcasting',
            'ML/temp/ConvLSTM_Config.py',
            'ML/temp/imerg_only_mse_params.pth',
            'False',
            'ML/temp/input_imerg.h5',
            'ML/temp/output_imerg.h5'
        ]
        ...
        cmd3 = [
            ...
            'ML/m_h5py2tif.py',
            'ML/temp/output_imerg.h5',
            'ML/temp/imerg_giotiff_meta.json',
            precipFolder
        ]
        subprocess.run(cmd3, check=True)
    except:
        print("    Something failed within ML-nowcast rountines")
        #Produce ML qpf from currentTime - 4h till currentime +2h
